...
This folder defines all source code for the 'uber_ride_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_uber_ride_pipeline.py" to get familiar with the syntax.
